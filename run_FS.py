...
#
# This script applies the Wasserstein Patch Prior reconstruction onto the 2D Fontainebleau Sandstone image
...
args.target_image_path='input_imgs/img_hr_FS.png'
args.scales=2
args.keops=True
args.n_iter_max=100
args.save=True
args.n_patches_out=4000
args.learn_image_path='input_imgs/img_learn_FS.png'
args.patch_size=6
...
wgenpatex.imsave('input_imgs/lr_FS.png',lr_img)
...
# save reconstruction
if not os.path.isdir('output_imgs_FS'):
    os.mkdir('output_imgs_FS')
if add_boundary>0:
    synth_img=synth_img[:,:,add_boundary:-add_boundary,add_boundary:-add_boundary]
wgenpatex.imsave('output_imgs_FS/synthesized_FS.png', synth_img)
